...
Singleton {
    ...
    property QtObject options: QtObject {
        ...
        property QtObject overview: QtObject {
            ...
            property real workspaceWidthScale: root.readReal("overview.workspaceWidthScale", scale)
            property real workspaceHeightScale: root.readReal("overview.workspaceHeightScale", scale)
